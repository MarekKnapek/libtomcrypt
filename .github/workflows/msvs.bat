...
%mk_vs_devenv% "%~dp0..\..\msvs\libtomcrypt.slnx" /Build "%mk_sln_conf%|%mk_sln_arch%" /Project "timing" /ProjectConfig "%mk_prj_conf%|%mk_prj_arch%" /Out "%~dp0..\..\msvs\timing-%mk_prj_conf%-%mk_prj_arch%.txt" || goto :mk_bad
