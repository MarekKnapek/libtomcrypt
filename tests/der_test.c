...
/* Wycheproof ecdh_brainpoolP224r1_test.json tcId=787 - reject SPKI whose BIT STRING "unused bits" byte is 0x80 (>7) */
   {
      static const unsigned char bad_bs[] = {
         /* outer SPKI; the BIT STRING starts at offset 24: 03 3a  80  04 d7 ba ...   -- unused-bits = 0x80 */
         0x30, 0x52, 0x30, 0x14, 0x06, 0x07, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x02, 0x01, 0x06, 0x09, 0x2b, 0x24, 0x03, 0x03, 0x02,
         0x08, 0x01, 0x01, 0x05, 0x03, 0x3a, 0x80, 0x04, 0xd7, 0xba, 0x2d, 0xf5, 0x81, 0xb4, 0x54, 0xd8, 0x3c, 0x6b, 0xb8, 0x65,
         0x0f, 0xc3, 0xa1, 0xf1, 0x35, 0x21, 0x88, 0x1f, 0xa2, 0xea, 0x52, 0x06, 0x1d, 0x9e, 0x3a, 0xf5, 0x4e, 0x82, 0x0e, 0x75,
         0xfb, 0x86, 0x22, 0x18, 0x3b, 0x69, 0x9d, 0x86, 0x87, 0x89, 0xbf, 0x36, 0x82, 0x88, 0x9d, 0x70, 0x21, 0x79, 0x8a, 0x3e,
         0x4b, 0xa2, 0x7b, 0x71
      };
      unsigned char out[512];
      unsigned long outlen = sizeof(out);
      SHOULD_FAIL(der_decode_bit_string(bad_bs + 24, sizeof(bad_bs) - 24, out, &outlen));
      outlen = sizeof(out);
      SHOULD_FAIL(der_decode_raw_bit_string(bad_bs + 24, sizeof(bad_bs) - 24, out, &outlen));
   }
